...
Теоретические задачи решены. Практически нужно было научиться работать с модулем часов, аккуратно спаять все детали, раздобыть подходящий корпус, найти достаточное количество проводов и придумать, как все закрепить.
## Hardware
